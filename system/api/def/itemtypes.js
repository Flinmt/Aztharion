...
export class ItemTypes extends BaseDefinitionClass {
  ...
  static feature = {
    ...
    img: 'systems/aztharion/assets/icons/items/feature.svg',
    types: ['feature'],
  ...
  static customRoll = {
    ...
    img: 'systems/aztharion/assets/icons/items/custom-roll.png',
    types: ['customRoll'],
  ...
  static power = {
    ...
    img: 'systems/aztharion/assets/icons/items/discipline.png',
    types: ['power'],
  ...
  static boon = {
    ...
    img: 'systems/aztharion/assets/icons/items/boon.svg',
    types: ['boon'],
  ...
  static perk = {
    ...
    img: 'systems/aztharion/assets/icons/items/edge.png',
    types: ['perk'],
  ...
  static edgepool = {
    ...
    img: 'systems/aztharion/assets/icons/items/edgepool.png',
    types: ['edgepool'],
  ...
  static gift = {
    ...
    img: 'systems/aztharion/assets/icons/items/gift.png',
    types: ['gift'],
