...
export class SPCActorSheet extends HandlebarsApplicationMixin(WoDActorBase) {
  static DEFAULT_OPTIONS = {
    classes: ['aztharion', 'actor', 'spc', 'sheet'],
    actions: {
  ...
  static PARTS = {
    header: {
      template: 'systems/aztharion/display/shared/actors/spc-sheet.hbs'
    },
    tabs: {
      template: 'systems/aztharion/display/shared/actors/parts/tab-navigation.hbs'
    },
    stats: {
      template: 'systems/aztharion/display/shared/actors/parts/spc/stats.hbs'
    },
    features: {
